...
workflow MPRAmodel {
  ...
  Int model_disk = ceil(size(count, "GB") + size(attributes, "GB") + 0.5*cell_num) + 1 ### Some calculation for the disk space needed for the project keeping in mind that we need to load files in as well as space for output files
